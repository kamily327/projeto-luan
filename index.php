    ...
    <div id="menuToggle" class="md:hidden fixed bottom-0 left-0 w-full z-50 text-black flex justify-center">
        ...
        <nav class="w-full">
            <ul class="text-white flex gap-1 items-center">
                ...
                <li class="w-full">
                    <a href="index.php" class="bg-[#1D1D1DE1] h-[62px] flex flex-col items-center justify-center font-noodle w-full text-[14px] tracking-wider text-white hover:text-luan-gold transition duration-200">
                ...
                <?php if (isset($_SESSION['usuario_id'])): ?>
                    ...
                    <li class="w-full">
                        <a href="meus_ingressos.php" class="bg-[#1D1D1DE1] h-[62px] flex flex-col items-center justify-center font-noodle w-full text-[14px] tracking-wider text-white hover:text-luan-gold transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-ticket-perforated mb-1" viewBox="0 0 16 16">
                ...
                <?php else: ?>
                    ...
                    <li class="w-full">
                        <a href="login.php" class="bg-[#1D1D1DE1] h-[62px] flex flex-col items-center justify-center font-noodle w-full text-[14px] tracking-wider text-white hover:text-luan-gold transition duration-200">
        ...
        <section class="relative min-h-[100dvh] md:h-[85vh] flex flex-col items-center justify-center overflow-hidden bg-pure-black px-6 pt-[100px] md:pt-[0px]">
            ...
            <div class="relative z-20 text-center mt-10">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-4">
                    <a href="#shows"  class="w-full sm:w-auto bg-luan-gold text-black font-black uppercase tracking-widest px-8 py-4 rounded-full hover:scale-105 transition transform duration-300 shadow-lg shadow-luan-gold/30">
                        Ver Datas Disponíveis
                    </a>

                    <a href="https://open.spotify.com/intl-pt/artist/3qvcCP2J0fWi0m0uQDUf6r?si=wnRd3U2xRzuD8X3k82hUfA" target="_blank" class="w-full sm:w-auto border border-white/20 text-white font-bold uppercase tracking-widest px-8 py-4 rounded-full hover:bg-white/10 transition duration-300 backdrop-blur-sm">
                        Ouvir no Spotify
                    </a>
                </div>
            </div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 w-full">
                ...
                <div class="flex justify-between md:flex-col gap-6">
                    ...
                    <div class="flex items-center gap-4 justify-center">
                        ...
                        <a href="https://open.spotify.com/intl-pt/artist/3qvcCP2J0fWi0m0uQDUf6r?si=HhmhdrTpSbaMpfXPdgJ-PA" target="_blank" class="hidden md:block bg-[#1DB954] text-black font-black px-8 py-3 rounded-full uppercase text-[10px] tracking-widest hover:scale-105 transition-all">
                            Acessar
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-12 pb-20 w-screen p-5">
                    ...
                    <div class="justify-end flex">
                        <div class="hover:scale-x-110 duration-500 transition-all">
                            <a href="https://youtube.com/@luansantana?si=ASG1lRiSBnSnfqla" target="_blank" class="text-white uppercase italic flex items-center justify-end gap-3 text-[20px] px-2 font-noodle">
                                Se inscrever no
...
<section id="contact" class="bg-[#0D0D0D] text-white py-12 px-4">
    <div class="max-w-4xl mx-auto text-center">
     
        <h2 class="font-noodle text-2xl md:text-3xl text-luan-gold tracking-wider mb-2">
            CONTATO / PORTFÓLIO
        </h2>
        <p class="text-gray-400 text-xs md:text-sm max-w-md mx-auto mb-8">
            Desenvolvido por Kamily Vitória. Se você gostou deste projeto, conecte-se comigo!
        </p>

        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl mx-auto">
           
     
            <a href="https://www.linkedin.com/in/kamilyreis" target="_blank" class="bg-[#1D1D1D] border border-luan-gold/40 hover:border-luan-gold p-4 rounded-xl flex flex-col items-center justify-center group transition duration-300">
                <div class="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center mb-2 group-hover:bg-luan-gold group-hover:text-black transition duration-300 text-luan-gold">
                ...
                <span class="font-noodle text-base tracking-wide mb-0.5">LinkedIn</span>
                <span class="text-[10px] text-gray-500">Conectar</span>
            </a>

          
            <a href="https://github.com/kamily327" target="_blank" class="bg-[#1D1D1D] border border-luan-gold/40 hover:border-luan-gold p-4 rounded-xl flex flex-col items-center justify-center group transition duration-300">
                <div class="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center mb-2 group-hover:bg-luan-gold group-hover:text-black transition duration-300 text-luan-gold">
                ...
                <span class="font-noodle text-base tracking-wide mb-0.5">GitHub</span>
                <span class="text-[10px] text-gray-500">Repositórios</span>
            </a>

         
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kamily219@gmail.com" target="_blank" class="bg-[#1D1D1D] border border-luan-gold/40 hover:border-luan-gold p-4 rounded-xl flex flex-col items-center justify-center group transition duration-300">
                <div class="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center mb-2 group-hover:bg-luan-gold group-hover:text-black transition duration-300 text-luan-gold">
                ...
                <span class="font-noodle text-base tracking-wide mb-0.5">E-mail</span>
                <span class="text-[10px] text-gray-500">Contato</span>
            </a>
        </div>
    </div>
</section>
    ...
    <footer class="bg-pure-black pt-3 text-center mt-[-5px] relative z-20">
        ...
        <div class="container mx-auto p-5">
            ...
            <h3 class="text-3xl uppercase flex flex-col tracking-widest items-center text-white/80  pr-4">
                Luan
